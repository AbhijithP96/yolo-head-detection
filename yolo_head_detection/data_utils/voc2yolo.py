...
def _convert_box(bbox, w, h):
    ...
    return 0, x*dw, y*dh, bw*dw, bh*dh # normalized box co-ordiante with single class index
...
def convert_voc_to_yolo(raw_data_dir: Path, interim_data_dir: Path, processed_data_dir: Path) -> None:
    """
