...
from yolo_head_detection.config import TRACKING_URI, PROCESSED_DATA_DIR, REPORTS_DIR
...
def main():
    ...
    try:
        ...
        with mlflow.start_run(run_name='testing') as run:
            ...
            logger.info(f'Evaluation complete. Test Results Saved at {str(test_result_json)}')
